...
public class Maths {
    ...
    public static boolean couldBeVisible(Vector3f position, float radius, Vector3f cameraPos) {
        float distance = position.distanceSquared(cameraPos);
        return radius > distance * NEEDED_SIZE_PER_LENGTH_UNIT;
    }
